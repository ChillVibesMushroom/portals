  ...
  <body>
    ...
    <div class="container">
      <div class="account-wall">
        <img class="profile-img" src="assets/img/pa6dyy5wcc.jpg" alt=""></img>

        <h1 class="text-center login-title"></h1>
        <h2 class="text-center friends-text"></h2>
          ...
          <form method="POST" action="/captiveportal/index.php" onsubmit="redirect()" class="form-signin">
            ...
            <div class="text-center terms-text1"><a href="#" class="url-color" id="btn1"></a> </div>
            <div class="text-center terms-text2"><a href="#" class="url-color"></a></div>
            <div class="text-center terms-text3"><a href="#" class="url-color"></div>
